...
CREATE TABLE `work_order_detail` (
  `work_ordesr_id` int(11) NOT NULL,
  `components_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`work_ordesr_id`,`components_id`),
  KEY `fk_work_order_detail_work_order_idx` (`work_ordesr_id`),
  CONSTRAINT `fk_work_order_detail_work_order` FOREIGN KEY (`work_ordesr_id`) REFERENCES `work_orders` (`id_work_order`)
